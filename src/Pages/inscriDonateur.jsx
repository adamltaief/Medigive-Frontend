...
import signupimage from '../assets/forms/images/donateur.png'
import '../assets/main/Css/Styles.css';
import '../assets/main/Css/Styles2.css';
import { ToastContainer, toast } from "react-toastify";

function IncriDonateur(){
  useEffect(()=>{
    window.scrollTo(0,0)
},[])
    ...
    if(mot_de_passe.trim() === "") toast.error("Le mot de passe est requis")
          ...
          return (
            ...
            <div style={{backgroundColor: '#1181b2'}}>
              <title>S'inscrire Donateur</title>
                  ...
                  <div style={{backgroundColor: '#1181b2',fontFamily:'open sans'}} className="containe">
                    <div className="signup-content">
                      <div className="signup-form">
                        <h2 style={{color:'white'}} className="form-title">S'inscrire comme un Donateur</h2>
                        <form 
                        method="POST"
                        action 
