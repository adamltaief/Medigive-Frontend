...
import signupimage from '../assets/forms/images/benevole.png'
import { ToastContainer, toast } from "react-toastify";

function InscriBenevole(){
  useEffect(()=>{
    window.scrollTo(0,0)
},[])
...
const formsubmitHandler = (e) => {
    ...
    if(competances.trim() === "") toast.error("Les competences sont requis")
                  ...
                  <div style={{backgroundColor: '#1181b2',fontFamily:'open sans'}} className="containe">
                    <div className="signup-content">
                      <div className="signup-form">
                        <h2 style={{color:'white'}} className="form-title">S'inscrire comme un Benevole</h2>
                        <form 
                        method="POST" 
                        action 
                        ...
                        >
                          ...
                          <div className="form-group">
                            <label style={{color:'white'}} htmlFor="competences"><i /></label>
                            <textarea 
                            style={{backgroundColor: '#1181b2' ,color:'white',borderBlockColor:'white'}} 
                            name="competences" 
                            id="competences" 
                            ...
                            value={competances}
                            onChange={(e) => setCompetances(e.target.value)}
                            />
                          ...
                          <div className="form-group">
                            ...
                            <label style={{color:'white'}} htmlFor="agree-term" className="label-agree-term"><span><span /></span>Je suis d'accord avec toutes les déclarations dans  <a style={{color:'white', fontWeight: 'bold'}} href={signupimage} className="term-service">Conditions d'utilisation</a></label>
                          </div>
